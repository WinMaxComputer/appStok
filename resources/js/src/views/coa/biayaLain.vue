                            ...
                            <div class="invoice-actions-btn">
                                <div class="invoice-action-btn">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-12 col-md-3 col-sm-6">
                                            <button type="button" class="btn btn-success btn-download w-100" @click="show_biaya_lain" :disabled="isLoadingList">
                                                <span v-if="isLoadingList" class="spinner-border spinner-border-sm me-1" role="status" aria-hidden="true"></span>
                                                {{ isLoadingList ? 'Memuat...' : 'Biaya Lain' }}
                                            </button>
                                        </div>
                                        <div class="col-xl-12 col-md-3 col-sm-6">
...
const hartalist = ref([]);
const judulPage = ref('Biaya Lain');
const currentGroup = ref('8');
const currentTitle = ref('Biaya Lain');

const modalTitle = computed(() => (selected.value.oldid ? 'Ubah Akun Biaya Lain' : 'Tambah Akun Biaya Lain'));
...
onMounted(async () => {
    await loadGroup('8', 'Biaya Lain');
});

const show_biaya_lain = async () => {
    await loadGroup('8', 'Biaya Lain');
};
