                            ...
                            <div class="invoice-actions-btn">
                                <div class="invoice-action-btn">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-12 col-md-3 col-sm-6">
                                            <button type="button" class="btn btn-success btn-download w-100" @click="show_penghasilan_lain" :disabled="isLoadingList">
                                                <span v-if="isLoadingList" class="spinner-border spinner-border-sm me-1" role="status" aria-hidden="true"></span>
                                                {{ isLoadingList ? 'Memuat...' : 'Penghasilan Lain' }}
                                            </button>
                                        </div>
                                        <div class="col-xl-12 col-md-3 col-sm-6">
...
const hartalist = ref([]);
const judulPage = ref('Penghasilan Lain');
const currentGroup = ref('7');
const currentTitle = ref('Penghasilan Lain');

const modalTitle = computed(() => (selected.value.oldid ? 'Ubah Akun Penghasilan Lain' : 'Tambah Akun Penghasilan Lain'));
...
onMounted(async () => {
    await loadGroup('7', 'Penghasilan Lain');
});

const show_penghasilan_lain = async () => {
    await loadGroup('7', 'Penghasilan Lain');
};
