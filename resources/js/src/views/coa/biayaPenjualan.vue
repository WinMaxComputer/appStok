                                ...
                                <div class="statbox panel box box-shadow">
                                    ...
                                    <div class="panel-body">
                                        <div class="table-responsive biaya-table-wrap">
                                            <table class="table table-sm biaya-table">
                                                <thead>
                                                    <tr>
                            ...
                            <template v-else>
                                ...
                                <div class="input-group input-group-sm mb-3">
                                    <select v-model="selected.parent" class="form-control" :disabled="String(selected.level) === '1'">
                                        ...
                                        <option v-for="parent in parentOptions" :key="parent.acc_id" :value="parent.acc_id">
                                            Akun Induk {{ parent.acc_id }} - {{ parent.name }}
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="invoice-actions-btn">
                                <div class="invoice-action-btn">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-12 col-md-3 col-sm-6">
                                            <button type="button" class="btn btn-success btn-download w-100" @click="show_biaya_penjualan" :disabled="isLoadingList">
                                                <span v-if="isLoadingList" class="spinner-border spinner-border-sm me-1" role="status" aria-hidden="true"></span>
                                                {{ isLoadingList ? 'Memuat...' : 'Biaya Penjualan / Hpp' }}
                                            </button>
                                        </div>
                                        <div class="col-xl-12 col-md-3 col-sm-6">
                                            <button type="button" class="btn btn-dark btn-edit w-100" @click="loadData" :disabled="isLoadingList">Muat Ulang</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script setup>
    ...
    const parentOptions = computed(() => {
        ...
        if (!hartalist.value?.length || level <= 1) {
            return [];
        }
