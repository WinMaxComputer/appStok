                            ...
                            <template #noPenjualan="props">
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <span class="row-action-icons">
                                        <a href="javascript:void(0);" class="row-action-icon text-primary" title="Lihat" @click="viewnota(id= props.row.noPenjualan)">
                                            <svg
                                        ...
                                        <a href="javascript:void(0);" class="row-action-icon text-warning" title="Edit" @click="editnota([{
                                        ...
                                        <a href="javascript:void(0);" class="row-action-icon text-danger" title="Hapus" @click="delete_row(props.row)">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                width="16"
                                                height="16"
...
<script setup>
    ...
    const columns = ref(['noPenjualan', 'tglPenjualan', 'nmPelanggan', 'typeBayar', 'piutangPenjualan', 'subTotalPenjualan', 'taxPenjualan', 'totalPenjualan', 'termPenjualan', 'jthTempo']);
    const items = ref([]);
