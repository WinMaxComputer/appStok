                ...
                <div class="panel br-6">
                    <div class="custom-table panel-body p-0">
                        ...
                        <ul class="nav nav-tabs mb-3 mt-3" id="simpletab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="home-tab" data-bs-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Daftar Piutang</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="profile-tab" data-bs-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Daftar Pembayaran Piutang</a>
                            </li>
                        </ul>
                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <v-client-table :data="items.filter(item => Number(item.piutangPenjualan) !== 0)" :columns="columns" :options="table_option">
                                    ...
                                    <template #action="props">
                                        <a href="javascript:void(0);" @click="openModal(id = props.row.noPenjualan, sisa = props.row.piutangPenjualan)" >
                                            <svg
...
<script setup>
    ...
    const columns_bayar = ref(['noBayar', 'tglBayar', 'nmPelanggan', 'noJual', 'jmlBayar' , 'action']);
    ...
    const delete_row = (data) => {
        new window.Swal({
            ...
            if (result.isConfirmed) {
                store.dispatch('DeletePembayaranPiutang', { id:data.noBayar})
                .then(response => {
                    bind_data();
