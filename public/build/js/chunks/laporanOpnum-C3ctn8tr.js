...
//#region resources/js/src/views/laporan/laporanOpnum.vue
...
var _hoisted_7 = { class: "panel-body" };
var _hoisted_8 = { class: "row" };
var _hoisted_9 = { class: "col-md-7" };
var _hoisted_10 = { class: "input-group mb-4" };
	...
	setup(__props) {
		...
		const export_table = (type) => {
			...
			if (type == "csv") {
				...
				records.map((item) => {
					...
					rowhtml += "<td>" + hooks(item.tglOpnum).format("DD-MM-YYYY") + "</td>";
		...
		const delete_row = (item) => {
			new window.Swal({
				...
				if (result.value) store.dispatch("DeleteOpnum", { id: item.r_opnum }).then((response) => {
					bind_data();
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("div", _hoisted_1, [(openBlock(), createBlock(Teleport, { to: "#breadcrumb" }, [_cache[4] || (_cache[4] = createBaseVNode("ul", { class: "navbar-nav flex-row" }, [createBaseVNode("li", null, [createBaseVNode("div", { class: "page-header" }, [createBaseVNode("nav", {
				...
				createBaseVNode("div", _hoisted_6, [_cache[5] || (_cache[5] = createBaseVNode("h5", null, "Daftar Transaksi Opnum", -1)), createBaseVNode("span", null, toDisplayString(_ctx.bbm), 1)]),
				createBaseVNode("div", _hoisted_7, [createBaseVNode("div", _hoisted_8, [createBaseVNode("div", _hoisted_9, [createBaseVNode("div", _hoisted_10, [
				...
				createVNode(_component_v_client_table, {
					...
					selisihOpnum: withCtx((props) => [createTextVNode(toDisplayString(Number(props.row.selisihOpnum).toLocaleString()), 1)]),
					nilaiOpnum: withCtx((props) => [createTextVNode(toDisplayString(Number(props.row.nilaiOpnum).toLocaleString()), 1)]),
