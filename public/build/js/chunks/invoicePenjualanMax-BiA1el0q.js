...
var _hoisted_44 = { class: "invoice-summary-col invoice-summary-col--signature" };
var _hoisted_45 = {
	key: 0,
				...
				createBaseVNode("div", _hoisted_6, [createBaseVNode("div", _hoisted_7, [createBaseVNode("div", {
					...
					items.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_28, [createBaseVNode("div", _hoisted_29, [createBaseVNode("table", _hoisted_30, [createBaseVNode("thead", null, [createBaseVNode("tr", null, [(openBlock(true), createElementBlock(Fragment, null, renderList(columns.value, (item) => {
						...
						return openBlock(), createElementBlock("tr", { key: item.id }, [
							...
							createBaseVNode("td", _hoisted_33, toDisplayString(item.satuanJual), 1),
					...
					createBaseVNode("div", _hoisted_42, [createBaseVNode("div", _hoisted_43, [
						_cache[27] || (_cache[27] = createBaseVNode("div", { class: "invoice-summary-col invoice-summary-col--notes" }, [createBaseVNode("div", { class: "invoice-bank-box" }, [createBaseVNode("div", { class: "inv-email-address" }, [
						...
						createBaseVNode("div", _hoisted_44, [ttdPenerima.value ? (openBlock(), createElementBlock("div", _hoisted_45, [
						...
						createBaseVNode("div", _hoisted_48, [createBaseVNode("div", _hoisted_49, [
							createBaseVNode("div", _hoisted_50, [_cache[22] || (_cache[22] = createBaseVNode("span", null, "Sub Total", -1)), createBaseVNode("span", null, toDisplayString(formatNumber(subtotalBarang.value)), 1)]),
							items_jasa.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_51, [_cache[23] || (_cache[23] = createBaseVNode("span", null, "Jasa", -1)), createBaseVNode("span", null, toDisplayString(formatNumber(subtotalJasa.value)), 1)])) : createCommentVNode("", true),
							createBaseVNode("div", _hoisted_52, [_cache[24] || (_cache[24] = createBaseVNode("span", null, "Total", -1)), createBaseVNode("span", null, toDisplayString(formatNumber(grandTotal.value)), 1)]),
							typeBayar.value !== "0" ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [createBaseVNode("div", _hoisted_53, [_cache[25] || (_cache[25] = createBaseVNode("span", null, "Payment", -1)), createBaseVNode("span", null, toDisplayString(formatNumber(totalBayar.value)), 1)]), createBaseVNode("div", _hoisted_54, [_cache[26] || (_cache[26] = createBaseVNode("span", null, "Sisa", -1)), createBaseVNode("span", null, toDisplayString(formatNumber(sisaBayar.value)), 1)])], 64)) : createCommentVNode("", true)
						])])
					])])
				])])])], 512)])]),
				createVNode(unref(D), {
