	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("div", _hoisted_1, [(openBlock(), createBlock(Teleport, { to: "#breadcrumb" }, [_cache[4] || (_cache[4] = createBaseVNode("ul", { class: "navbar-nav flex-row" }, [createBaseVNode("li", null, [createBaseVNode("div", { class: "page-header" }, [createBaseVNode("nav", {
				...
				_cache[11] || (_cache[11] = createBaseVNode("div", { class: "d-flex flex-wrap justify-content-center justify-content-sm-start px-3 pt-3 pb-0" }, [createBaseVNode("h5", null, "Daftar Pembelian")], -1)),
				createBaseVNode("div", _hoisted_6, [createBaseVNode("div", _hoisted_7, [
					...
					createBaseVNode("div", _hoisted_10, [createBaseVNode("div", _hoisted_11, [_cache[5] || (_cache[5] = createBaseVNode("label", null, "Total Pembelian :", -1)), createBaseVNode("label", null, toDisplayString(Number(totalPembelian.value).toLocaleString()), 1)])]),
					createBaseVNode("div", _hoisted_12, [createBaseVNode("div", _hoisted_13, [_cache[6] || (_cache[6] = createBaseVNode("label", null, "Total Hutang :", -1)), createBaseVNode("label", null, toDisplayString(Number(totalHutang.value).toLocaleString()), 1)])]),
				...
				createVNode(_component_v_client_table, {
					...
					}, [createBaseVNode("path", { d: "M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z" })], -1)]), 8, _hoisted_16), createBaseVNode("a", {
						href: "javascript:void(0);",
