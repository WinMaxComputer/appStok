...
import { E as createVNode, F as onBeforeMount, G as resolveComponent, L as onMounted, Mt as toDisplayString, S as createElementBlock, T as createTextVNode, X as withCtx, b as createBlock, et as init_reactivity_esm_bundler, g as Teleport, j as init_runtime_core_esm_bundler, mt as init_shared_esm_bundler, ot as unref, rt as ref, t as useMeta, v as computed, x as createCommentVNode, y as createBaseVNode, z as openBlock } from "./use-meta-Cs_oC8eH.js";
import { a as useRoute, o as useRouter, s as useStore } from "../../assets/main-C-Jy3aFl.js";
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("div", _hoisted_1, [(openBlock(), createBlock(Teleport, { to: "#breadcrumb" }, [_cache[4] || (_cache[4] = createBaseVNode("ul", { class: "navbar-nav flex-row" }, [createBaseVNode("li", null, [createBaseVNode("div", { class: "page-header" }, [createBaseVNode("nav", {
				...
				createVNode(_component_v_client_table, {
					...
					noPenjualan: withCtx((props) => [createBaseVNode("a", {
						href: "javascript:void(0);",
						onClick: ($event) => viewnota(_ctx.id = props.row.noPenjualan)
					}, toDisplayString(props.row.noPenjualan), 9, _hoisted_16)]),
					...
					action: withCtx((props) => [
						...
						}, [createBaseVNode("path", { d: "M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z" })], -1)]), 8, _hoisted_18),
						createBaseVNode("a", {
							href: "javascript:void(0);",
