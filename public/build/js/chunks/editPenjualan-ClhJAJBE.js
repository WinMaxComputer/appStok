...
var _hoisted_35 = { class: "invoice-detail-items" };
...
var _hoisted_44 = { class: "form-group col-sm-1" };
var _hoisted_45 = {
	class: "tab-pane fade",
	id: "profile",
	role: "tabpanel",
...
var _hoisted_46 = { class: "invoice-detail-items" };
...
var _hoisted_52 = { class: "form-group col-sm-1" };
var _hoisted_53 = { class: "row" };
var _hoisted_54 = { class: "form-group col-md-6" };
var _hoisted_55 = { class: "invoice-detail-items" };
var _hoisted_56 = { class: "inv--product-table-section" };
var _hoisted_57 = { class: "table-responsive" };
...
var _hoisted_70 = { class: "table-responsive" };
...
var _hoisted_80 = { class: "invoice-detail-total" };
...
var _sfc_main = {
	...
	setup(__props) {
		...
		const simpanPenjualan = () => {
			store.dispatch("DeletePenjualan", { id: params.value.noNota }).then((response) => {
		...
		function addToCart(brg) {
			store.dispatch("CheckBarangExist", { kdBarang: brg.kdBarang }).then((response) => {
				const brgasli = response.data.data;
				if (brgasli.stokPersediaan < qty.value) {
					if (!window.confirm("Stok barang kurang")) return;
				} else {
		...
		function addToCartB(barcode) {
			store.dispatch("CheckBarangExist", { kdBarang: barcode }).then((response) => {
				...
				if (brg.stokPersediaan < 1) {
					if (!window.confirm("Stok barang kurang dari 1. Jika dilanjukan akan mempengaruhi perhitungan laba rugi.")) return;
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1, [(openBlock(), createBlock(Teleport, { to: "#breadcrumb" }, [_cache[26] || (_cache[26] = createBaseVNode("ul", { class: "navbar-nav flex-row" }, [createBaseVNode("li", null, [createBaseVNode("div", { class: "page-header" }, [createBaseVNode("nav", {
				...
				_cache[71] || (_cache[71] = createBaseVNode("div", { class: "invoice-detail-title" }, [createBaseVNode("div", { class: "invoice-title" }, " Edit Invoice Penjualan ")], -1)),
				createBaseVNode("div", _hoisted_9, [createBaseVNode("div", _hoisted_10, [createBaseVNode("div", _hoisted_11, [createBaseVNode("div", _hoisted_12, [
					createBaseVNode("div", _hoisted_13, [_cache[27] || (_cache[27] = createBaseVNode("label", {
						for: "company-name",
					...
					createBaseVNode("div", _hoisted_15, [_cache[28] || (_cache[28] = createBaseVNode("label", {
						for: "company-email",
						class: "col-sm-3 col-form-label col-form-label-sm"
					...
					createBaseVNode("div", _hoisted_17, [_cache[29] || (_cache[29] = createBaseVNode("label", {
						for: "company-address",
						class: "col-sm-3 col-form-label col-form-label-sm"
					...
					createBaseVNode("div", _hoisted_20, [_cache[30] || (_cache[30] = createBaseVNode("label", {
						for: "company-phone",
						class: "col-sm-3 col-form-label col-form-label-sm"
					...
					createBaseVNode("div", _hoisted_24, [_cache[31] || (_cache[31] = createBaseVNode("label", {
						for: "client-name",
						class: "col-sm-3 col-form-label col-form-label-sm"
					...
					createBaseVNode("div", _hoisted_26, [_cache[32] || (_cache[32] = createBaseVNode("label", {
						for: "client-address",
						class: "col-sm-3 col-form-label col-form-label-sm"
					...
					createBaseVNode("div", _hoisted_28, [_cache[33] || (_cache[33] = createBaseVNode("label", {
						for: "client-phone",
						class: "col-sm-3 col-form-label col-form-label-sm"
				...
				createBaseVNode("div", _hoisted_30, [createBaseVNode("ul", _hoisted_31, [_cache[35] || (_cache[35] = createBaseVNode("li", { class: "nav-item" }, [createBaseVNode("a", {
					...
					"aria-controls": "home",
					"aria-selected": "true"
				}, "BARANG")], -1)), unref(store).state.auth.user === "root" ? (openBlock(), createElementBlock("li", _hoisted_32, _cache[34] || (_cache[34] = [createBaseVNode("a", {
					class: "nav-link",
					id: "profile-tab",
					"data-bs-toggle": "tab",
					href: "#profile",
					...
					createBaseVNode("div", _hoisted_37, [_cache[36] || (_cache[36] = createBaseVNode("label", { for: "Inputqty" }, "Barcode", -1)), withDirectives(createBaseVNode("input", {
						type: "text",
						ref: "InputBarcode",
					...
					createBaseVNode("div", _hoisted_38, [_cache[37] || (_cache[37] = createBaseVNode("label", { for: "inputCity" }, "NAMA BARANG", -1)), createVNode(unref(import_vue3_multiselect_umd_min.default), {
					...
					createBaseVNode("div", _hoisted_39, [_cache[38] || (_cache[38] = createBaseVNode("label", { for: "inputState" }, "HARGA", -1)), withDirectives(createBaseVNode("input", {
						type: "text",
						"onUpdate:modelValue": _cache[10] || (_cache[10] = ($event) => brg.value.hrgJual = $event),
						class: "form-control form-control-sm",
						placeholder: "Price",
						onKeypress: onlyNumber
					}, null, 544), [[vModelText, brg.value.hrgJual]])]),
					createBaseVNode("div", _hoisted_40, [_cache[39] || (_cache[39] = createBaseVNode("label", { for: "inputZip" }, "QTY", -1)), withDirectives(createBaseVNode("input", {
						type: "text",
					...
					createBaseVNode("div", _hoisted_41, [_cache[40] || (_cache[40] = createBaseVNode("label", { for: "inputZip" }, "Disc", -1)), withDirectives(createBaseVNode("input", {
						type: "text",
						"onUpdate:modelValue": _cache[12] || (_cache[12] = ($event) => disc.value = $event),
						class: "form-control form-control-sm",
						placeholder: "Diskon",
						onKeypress: onlyNumber
					}, null, 544), [[vModelText, disc.value]])]),
					createBaseVNode("div", _hoisted_42, [_cache[41] || (_cache[41] = createBaseVNode("label", { for: "satuan" }, "SATUAN", -1)), withDirectives(createBaseVNode("input", {
						type: "text",
						"onUpdate:modelValue": _cache[13] || (_cache[13] = ($event) => brg.value.satuanBarang = $event),
						class: "form-control form-control-sm",
						id: "satuan"
					}, null, 512), [[vModelText, brg.value.satuanBarang]])]),
					createBaseVNode("div", _hoisted_43, [
						_cache[42] || (_cache[42] = createBaseVNode("label", { for: "inputZip" }, "TOTAL", -1)),
						_cache[43] || (_cache[43] = createBaseVNode("br", null, null, -1)),
						withDirectives(createBaseVNode("input", {
							type: "text",
							"onUpdate:modelValue": _cache[14] || (_cache[14] = ($event) => tot.value = $event),
							class: "form-control form-control-sm",
							placeholder: "Quantity",
							onKeypress: onlyNumber
						}, null, 544), [[vModelText, tot.value]])
					]),
					createBaseVNode("div", _hoisted_44, [_cache[44] || (_cache[44] = createBaseVNode("label", { for: "aksi" }, "Aksi", -1)), createBaseVNode("button", {
						onClick: _cache[15] || (_cache[15] = ($event) => addToCart(brg.value)),
						class: "btn btn-xs btn-primary"
					}, " + ")])
				])])]), createBaseVNode("div", _hoisted_45, [createBaseVNode("div", _hoisted_46, [createBaseVNode("div", _hoisted_47, [
					createBaseVNode("div", _hoisted_48, [_cache[45] || (_cache[45] = createBaseVNode("label", { for: "inputCity" }, "NAMA JASA", -1)), createVNode(unref(import_vue3_multiselect_umd_min.default), {
						modelValue: jsa.value,
						"onUpdate:modelValue": _cache[16] || (_cache[16] = ($event) => jsa.value = $event),
					...
					createBaseVNode("div", _hoisted_49, [_cache[46] || (_cache[46] = createBaseVNode("label", { for: "inputState" }, "HARGA", -1)), withDirectives(createBaseVNode("input", {
						type: "text",
						"onUpdate:modelValue": _cache[17] || (_cache[17] = ($event) => jsa.value.biayaJasa = $event),
						class: "form-control form-control-sm",
						placeholder: "Price",
						onKeypress: onlyNumber
					}, null, 544), [[vModelText, jsa.value.biayaJasa]])]),
					createBaseVNode("div", _hoisted_50, [_cache[47] || (_cache[47] = createBaseVNode("label", { for: "inputZip" }, "QTY", -1)), withDirectives(createBaseVNode("input", {
						type: "text",
						"onUpdate:modelValue": _cache[18] || (_cache[18] = ($event) => qtyjasa.value = $event),
						class: "form-control form-control-sm",
						placeholder: "Quantity",
						onKeypress: onlyNumber
					}, null, 544), [[vModelText, qtyjasa.value]])]),
					createBaseVNode("div", _hoisted_51, [
						_cache[48] || (_cache[48] = createBaseVNode("label", { for: "inputZip" }, "TOTAL", -1)),
						_cache[49] || (_cache[49] = createBaseVNode("br", null, null, -1)),
						withDirectives(createBaseVNode("input", {
							type: "text",
							"onUpdate:modelValue": _cache[19] || (_cache[19] = ($event) => totjasa.value = $event),
							class: "form-control form-control-sm",
							placeholder: "Quantity",
							onKeypress: onlyNumber
						}, null, 544), [[vModelText, totjasa.value]])
					]),
					createBaseVNode("div", _hoisted_52, [_cache[50] || (_cache[50] = createBaseVNode("label", { for: "aksi" }, "Aksi", -1)), createBaseVNode("button", {
						onClick: _cache[20] || (_cache[20] = ($event) => addToCartJasa(jsa.value)),
						class: "btn btn-xs btn-primary"
					}, " + ")])
				]), createBaseVNode("div", _hoisted_53, [createBaseVNode("div", _hoisted_54, [_cache[51] || (_cache[51] = createBaseVNode("label", { for: "inputState" }, "Note", -1)), withDirectives(createBaseVNode("textarea", {
					"onUpdate:modelValue": _cache[21] || (_cache[21] = ($event) => jsa.value.note = $event),
					class: "form-control form-control-sm",
					placeholder: "Price"
				}, null, 512), [[vModelText, jsa.value.note]])])])])])])]),
				createBaseVNode("div", _hoisted_55, [createBaseVNode("div", _hoisted_56, [createBaseVNode("div", _hoisted_57, [createBaseVNode("table", _hoisted_58, [_cache[53] || (_cache[53] = createBaseVNode("thead", null, [createBaseVNode("tr", null, [
					...
					return openBlock(), createElementBlock("tr", { key: item.kdBarang }, [
						...
						createBaseVNode("td", _hoisted_64, toDisplayString(new Intl.NumberFormat().format(item.disc)), 1),
						...
						}, _cache[52] || (_cache[52] = [createStaticVNode("<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"24\" height=\"24\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\" class=\"feather feather-trash-2\"><polyline points=\"3 6 5 6 21 6\"></polyline><path d=\"M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2\"></path><line x1=\"10\" y1=\"11\" x2=\"10\" y2=\"17\"></line><line x1=\"14\" y1=\"11\" x2=\"14\" y2=\"17\"></line></svg>", 1)]), 8, _hoisted_67)])
					]);
				}), 128))])])])])]),
				_ctx.$store.state.auth.user === "root" ? (openBlock(), createElementBlock("div", _hoisted_68, [createBaseVNode("div", _hoisted_69, [createBaseVNode("div", _hoisted_70, [createBaseVNode("table", _hoisted_71, [_cache[54] || (_cache[54] = createBaseVNode("thead", null, [createBaseVNode("tr", null, [
				...
				createBaseVNode("div", _hoisted_80, [createBaseVNode("div", _hoisted_81, [createBaseVNode("div", _hoisted_82, [createBaseVNode("div", _hoisted_83, [createBaseVNode("div", _hoisted_84, [createBaseVNode("div", _hoisted_85, [createBaseVNode("div", _hoisted_86, [createBaseVNode("button", {
					onClick: _cache[22] || (_cache[22] = ($event) => openModal()),
					class: "btn btn-success btn-download"
				}, "PAYMENT")])])])])]), createBaseVNode("div", _hoisted_87, [createBaseVNode("div", _hoisted_88, [
					createBaseVNode("div", _hoisted_89, [
						_cache[56] || (_cache[56] = createBaseVNode("div", { class: "invoice-summary-label" }, "Sub Total", -1)),
						_cache[57] || (_cache[57] = createBaseVNode("div", { class: "invoice-summary-label" }, null, -1)),
						createBaseVNode("div", _hoisted_90, [createBaseVNode("div", _hoisted_91, [_cache[55] || (_cache[55] = createBaseVNode("span", { class: "currency" }, null, -1)), createBaseVNode("span", _hoisted_92, toDisplayString(new Intl.NumberFormat().format(subtotal.value)), 1)])])
					]),
					_ctx.$store.state.auth.user === "root" ? (openBlock(), createElementBlock("div", _hoisted_93, [
						_cache[59] || (_cache[59] = createBaseVNode("div", { class: "invoice-summary-label" }, "Total Jasa", -1)),
						_cache[60] || (_cache[60] = createBaseVNode("div", { class: "invoice-summary-label" }, null, -1)),
						createBaseVNode("div", _hoisted_94, [createBaseVNode("div", _hoisted_95, [_cache[58] || (_cache[58] = createBaseVNode("span", { class: "currency" }, null, -1)), createBaseVNode("span", _hoisted_96, toDisplayString(new Intl.NumberFormat().format(subtotaljasa.value)), 1)])])
					])) : createCommentVNode("", true),
					withDirectives(createBaseVNode("div", null, [createBaseVNode("div", _hoisted_97, [_cache[62] || (_cache[62] = createBaseVNode("div", { class: "invoice-summary-label" }, "Pajak", -1)), createBaseVNode("div", _hoisted_98, [createBaseVNode("div", _hoisted_99, [_cache[61] || (_cache[61] = createBaseVNode("span", { class: "currency" }, null, -1)), createBaseVNode("span", null, toDisplayString(new Intl.NumberFormat().format(Math.floor(tax.value))), 1)])])])], 512), [[vShow, divpajak.value]]),
					createBaseVNode("div", _hoisted_100, [_cache[64] || (_cache[64] = createBaseVNode("div", { class: "invoice-summary-label" }, "Total", -1)), createBaseVNode("div", _hoisted_101, [createBaseVNode("div", _hoisted_102, [_cache[63] || (_cache[63] = createBaseVNode("span", { class: "currency" }, null, -1)), createBaseVNode("span", null, toDisplayString(new Intl.NumberFormat().format(Math.floor(total.value))), 1)])])])
				])])])]),
				createVNode(unref(D), {
					visible: isVisible.value,
					"onUpdate:visible": _cache[24] || (_cache[24] = ($event) => isVisible.value = $event),
					draggable: true,
					...
					default: withCtx(() => [
						createBaseVNode("div", _hoisted_103, [_cache[67] || (_cache[67] = createBaseVNode("label", { class: "form-label" }, "Riwayat Pembayaran", -1)), createBaseVNode("table", _hoisted_104, [_cache[66] || (_cache[66] = createBaseVNode("thead", null, [createBaseVNode("tr", null, [
						...
						}), 128)), !listPembayaran.value || listPembayaran.value.length === 0 ? (openBlock(), createElementBlock("tr", _hoisted_105, _cache[65] || (_cache[65] = [createBaseVNode("td", {
							colspan: "4",
							class: "text-center"
						...
						params.value.term === "0" ? (openBlock(), createElementBlock("div", _hoisted_115, [createBaseVNode("div", _hoisted_116, [createBaseVNode("div", _hoisted_117, [_cache[69] || (_cache[69] = createBaseVNode("div", { style: { "font-size": "20px" } }, "Method", -1)), createBaseVNode("div", _hoisted_118, [createBaseVNode("div", _hoisted_119, [withDirectives(createBaseVNode("select", { "onUpdate:modelValue": _cache[23] || (_cache[23] = ($event) => paramsbayar.value.metodeBayar = $event) }, _cache[68] || (_cache[68] = [
				...
				createBaseVNode("div", _hoisted_120, [createBaseVNode("div", _hoisted_121, [createBaseVNode("div", _hoisted_122, [createBaseVNode("div", _hoisted_123, [_cache[70] || (_cache[70] = createBaseVNode("label", {
					...
					"onUpdate:modelValue": _cache[25] || (_cache[25] = ($event) => params.value.notes = $event),
					rows: "3",
