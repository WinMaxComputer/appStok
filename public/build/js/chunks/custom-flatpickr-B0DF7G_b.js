import { a as __toCommonJS, n as __esmMin, r as __exportAll, t as __commonJSMin } from "./rolldown-runtime-D1cXj70v.js";
...
var esm_exports = /* @__PURE__ */ __exportAll({ default: () => flatpickr });
...
var __assign, __spreadArrays, DEBOUNCED_CHANGE_MS, flatpickr;
...
//#endregion
//#region node_modules/vue-flatpickr-component/dist/vue-flatpickr.min.js
var require_vue_flatpickr_min = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(e, t) {
		"object" == typeof exports && "object" == typeof module ? module.exports = t((init_esm(), __toCommonJS(esm_exports)), require_vue()) : "function" == typeof define && define.amd ? define("VueFlatpickr", ["flatpickr", "vue"], t) : "object" == typeof exports ? exports.VueFlatpickr = t((init_esm(), __toCommonJS(esm_exports)), require_vue()) : e.VueFlatpickr = t(e.flatpickr, e.Vue);
	})(self, (function(e, t) {
		return (() => {
			"use strict";
			var n = {
			...
			return (() => {
				...
				const n = [
					...
					"onOpen",
					"onYearChange"
				], o = (e) => e.replace(/([a-z])([A-Z])/g, "$1-$2").toLowerCase(), i = (e) => e instanceof Array ? e : [e], s = (e) => e && e.length ? e : null, l = (e) => Object.assign({}, e);
				var u = r(976);
				const p = n.concat([
					"onValueUpdate",
					"onDayCreate",
					...
					emits: ["blur", "update:modelValue"].concat(p.map(o)),
					props: {
						modelValue: {
							default: null,
							required: !0,
							validator: (e) => null === e || e instanceof Date || "string" == typeof e || e instanceof String || e instanceof Array || "number" == typeof e
						},
						config: {
							type: Object,
							default: () => ({
					...
					mounted() {
						...
						this.events.forEach(((r) => {
							let a = t().defaultConfig[r] || [];
							n[r] = i(n[r] || []).concat(a, (function() {
								for (var t = arguments.length, n = new Array(t), a = 0; a < t; a++) n[a] = arguments[a];
								e.$emit(o(r), ...n);
							}));
						}));
						n.onClose = i(n.onClose || []).concat((function() {
							e.onClose(...arguments);
						})), n.defaultDate = this.modelValue || n.defaultDate, this.fp = new (t())(this.getElem(), n), this.fpInput().addEventListener("blur", this.onBlur), this.$watch("disabled", this.watchDisabled, { immediate: !0 });
					},
					methods: {
						getElem() {
						...
						onInput(e) {
							const t = e.target;
							(0, u.nextTick)().then((() => {
								this.$emit("update:modelValue", s(t.value));
							}));
						},
						fpInput() {
						...
						onBlur(e) {
							this.$emit("blur", s(e.target.value));
						},
						onClose(e, t) {
					...
					watch: {
						config: {
							...
							handler(e) {
								...
								p.forEach(((e) => {
									delete t[e];
								})), this.fp.set(t), f.forEach(((e) => {
									void 0 !== t[e] && this.fp.set(e, t[e]);
								}));
							}
						},
						modelValue(e) {
							this.$refs.root && e !== s(this.$refs.root.value) && this.fp && this.fp.setDate(e, !0);
						}
					},
					beforeUnmount() {
				...
				d.install = (e, t) => {
					let n = "flat-pickr";
					"string" == typeof t && (n = t), e.component(n, d);
				};
				const c = d;
			})(), a = a.default;
		})();
...
//#endregion
export { require_vue_flatpickr_min as t };
