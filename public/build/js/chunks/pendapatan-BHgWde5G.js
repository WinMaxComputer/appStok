...
var pendapatan_default = /*#__PURE__*/ _plugin_vue_export_helper_default({
	...
	setup(__props) {
		...
		const hartalist = ref([]);
		const judulPage = ref("Pendapatan");
		const currentGroup = ref("4");
		const currentTitle = ref("Pendapatan");
		...
		onMounted(async () => {
			await loadGroup("4", "Pendapatan");
		});
		const show_pendapatan = async () => {
			await loadGroup("4", "Pendapatan");
		};
			...
			return openBlock(), createElementBlock("div", _hoisted_1, [(openBlock(), createBlock(Teleport, { to: "#breadcrumb" }, [_cache[7] || (_cache[7] = createBaseVNode("ul", { class: "navbar-nav flex-row" }, [createBaseVNode("li", null, [createBaseVNode("div", { class: "page-header" }, [createBaseVNode("nav", {
				...
				createBaseVNode("div", _hoisted_36, [createBaseVNode("div", _hoisted_37, [createBaseVNode("div", _hoisted_38, [createBaseVNode("div", _hoisted_39, [
					...
					createBaseVNode("div", _hoisted_40, [createBaseVNode("button", {
						...
						onClick: show_pendapatan,
						disabled: isLoadingList.value
					}, [isLoadingList.value ? (openBlock(), createElementBlock("span", _hoisted_42)) : createCommentVNode("", true), createTextVNode(" " + toDisplayString(isLoadingList.value ? "Memuat..." : "Pendapatan"), 1)], 8, _hoisted_41)]),
