import { A as h, D as defineComponent, X as watch, it as ref, j as init_runtime_core_esm_bundler, rt as reactive, tt as init_reactivity_esm_bundler } from "./use-meta-CmUwIrPP.js";
//#region node_modules/usemodal-vue3/index.mjs
...
var D = defineComponent({
	...
	setup(e, { slots: g, emit: d }) {
		let n;
		const l = e.name, v = typeof e.width == "string" ? e.width : `${e.width}px`, C = typeof e.offsetTop == "string" ? e.offsetTop : `${e.offsetTop}px`, T = ref(null), h$1 = ref(null);
		let j = null, x = null, o = reactive({
			init: -15,
			value: -15,
			max: 0,
			step: 1,
		...
		const E = (t, s) => {
			...
			let s = h$1.value.offsetLeft, u = h$1.value.offsetTop, B = {
				width: h$1.value.offsetWidth,
				height: h$1.value.offsetHeight,
		...
		return watch(() => e.draggable, (t) => {
			...
			if (g.default) {
				...
				return O(e.visible) ? t = e.visible : (t = e.visible.currVisible[l], n = e.visible.dep), t ? (a.value && y(b), e.animation === !1 ? o.value = o.max : (j != l && (j = l, o.value = o.init), o.speed = 5, y(o)), o.value >= o.max && !r.value && x != l && (x = l, d("onVisible"))) : (x == l || !l) && (e.animation === !1 ? t = !1 : (t = !0, o.speed = 2, y(o, !0, () => {
				...
				}))), t ? h("div", { class: e.modalClass }, [e.mask ? h("div", {
					...
					}, [h("div", null, e.title), e.closable ? h("div", {
						style: "width:20px;height:16px;cursor:pointer;position:absolute;top:15px;right:15px;font-size: 20px;",
						onclick: () => {
							k(l);
						}
					}, [h("div", { style: "width:14px;height:1px;position:absolute;left:0;right:0;top:0;bottom:0;margin:auto;background-color:#999;transform:rotate(45deg);" }, ""), h("div", { style: "width:14px;height:1px;position:absolute;left:0;right:0;top:0;bottom:0;margin:auto;background-color:#999;transform:rotate(-45deg);" }, "")]) : null]) : null,
					h("div", {
					...
					}, [a.value && a.target === "cancelButton" ? h("span", { style: `width: 10px;height:10px;margin-right:5px;border:1px solid #666;border-radius:50%;border-top:1px solid transparent; transform:rotate(${b.value}deg);` }) : null, h("div", { style: "min-width:44px;text-align:center;" }, e.cancelButton.text || "cancel")]), h("div", {
					...
					}, [a.value && a.target === "okButton" ? h("span", { style: `width: 10px;height:10px;margin-right:5px;border:1px solid #fff;border-radius:50%;border-top:1px solid transparent; transform:rotate(${b.value}deg);` }) : null, h("div", { style: "min-width:44px;text-align:center;" }, e.okButton.text || "ok")])]) : null
				])])]) : null;
			}
		};
	}
