...
import { c as useStore, s as useRouter } from "../../assets/main-B6cAUmtZ.js";
import { n as E, r as init_jspdf_es_min, t as require_jspdf_plugin_autotable } from "./jspdf.plugin.autotable-RoyLOMaq.js";
...
//#region resources/js/src/views/transaksi/pembayaranPiutang.vue
...
var _sfc_main = {
	...
	setup(__props) {
		...
		const bind_data = () => {
			store.dispatch("GetLaporanBarang", sorting.value).then(() => {
			...
			store.dispatch("GetListBayarPenjualan", sorting.value).then(() => {
				listPembayaran.value = store.getters.SlistBayarPenjualan;
			});
		};
		computed(() => {
		...
		const delete_row = (data) => {
			new window.Swal({
				title: "Anda Yakin?",
				text: "Hapus Penjualan !" + data.noBayar,
				type: "warning",
				showCancelButton: true,
				confirmButtonText: "Delete",
				padding: "2em"
			}).then((result) => {
				if (result.isConfirmed) store.dispatch("DeletePembayaranPiutang", { id: data.noBayar }).then((response) => {
					bind_data();
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("div", _hoisted_1, [(openBlock(), createBlock(Teleport, { to: "#breadcrumb" }, [_cache[7] || (_cache[7] = createBaseVNode("ul", { class: "navbar-nav flex-row" }, [createBaseVNode("li", null, [createBaseVNode("div", { class: "page-header" }, [createBaseVNode("nav", {
				...
				"aria-current": "page"
			}, [createBaseVNode("span", null, "HTML5 Export")])])])])])], -1))])), createBaseVNode("div", _hoisted_2, [createBaseVNode("div", _hoisted_3, [createBaseVNode("div", _hoisted_4, [createBaseVNode("div", _hoisted_5, [_cache[18] || (_cache[18] = createBaseVNode("ul", {
				...
				"aria-controls": "home",
				"aria-selected": "true"
			}, "Daftar Piutang")]), createBaseVNode("li", { class: "nav-item" }, [createBaseVNode("a", {
				class: "nav-link",
				id: "profile-tab",
				"data-bs-toggle": "tab",
				href: "#profile",
				...
				"aria-selected": "false"
			}, "Daftar Pembayaran Piutang")])], -1)), createBaseVNode("div", _hoisted_6, [createBaseVNode("div", _hoisted_7, [
				createBaseVNode("div", _hoisted_8, [createBaseVNode("div", _hoisted_9, [
					...
					createBaseVNode("div", _hoisted_14, [createBaseVNode("div", _hoisted_15, [_cache[8] || (_cache[8] = createBaseVNode("label", null, "Total Piutang :", -1)), createBaseVNode("label", null, toDisplayString(Number(totalPiutang.value).toLocaleString()), 1)])]),
				...
				createVNode(_component_v_client_table, {
					data: items.value.filter((item) => Number(item.piutangPenjualan) !== 0),
					columns: columns.value,
					options: table_option.value
				}, {
					tglPenjualan: withCtx((props) => [createTextVNode(toDisplayString(unref(hooks)(props.row.tglPenjualan).format("DD-MM-YYYY")), 1)]),
					piutangPenjualan: withCtx((props) => [createTextVNode(toDisplayString(Number(props.row.piutangPenjualan).toLocaleString()), 1)]),
					totalPenjualan: withCtx((props) => [createTextVNode(toDisplayString(Number(props.row.totalPenjualan).toLocaleString()), 1)]),
					taxPenjualan: withCtx((props) => [createTextVNode(toDisplayString(Number(props.row.taxPenjualan).toLocaleString()), 1)]),
					...
					action: withCtx((props) => [createBaseVNode("a", {
						...
						onClick: ($event) => openModal(_ctx.id = props.row.noPenjualan, _ctx.sisa = props.row.piutangPenjualan)
				...
				createVNode(unref(D), {
					...
					default: withCtx(() => [
						createBaseVNode("div", _hoisted_18, [_cache[12] || (_cache[12] = createBaseVNode("label", { class: "form-label" }, "Riwayat Pembayaran", -1)), createBaseVNode("table", _hoisted_19, [_cache[11] || (_cache[11] = createBaseVNode("thead", null, [createBaseVNode("tr", null, [
						...
						}), 128)), !listPembayaran.value || listPembayaran.value.length === 0 ? (openBlock(), createElementBlock("tr", _hoisted_20, _cache[10] || (_cache[10] = [createBaseVNode("td", {
							colspan: "4",
							class: "text-center"
						}, "Belum ada pembayaran", -1)]))) : createCommentVNode("", true)])])]),
						createBaseVNode("div", _hoisted_21, [createBaseVNode("div", _hoisted_22, [createBaseVNode("div", _hoisted_23, [_cache[13] || (_cache[13] = createBaseVNode("div", { style: { "font-size": "20px" } }, " Sisa ", -1)), createBaseVNode("div", _hoisted_24, [createBaseVNode("div", _hoisted_25, [createBaseVNode("span", _hoisted_26, toDisplayString(new Intl.NumberFormat().format(Math.floor(sisaPiutang.value))), 1)])])])])]),
						createBaseVNode("div", _hoisted_27, [createBaseVNode("div", _hoisted_28, [createBaseVNode("div", _hoisted_29, [_cache[15] || (_cache[15] = createBaseVNode("div", { style: { "font-size": "20px" } }, "Method", -1)), createBaseVNode("div", _hoisted_30, [createBaseVNode("div", _hoisted_31, [withDirectives(createBaseVNode("select", { "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => paramsbayar.value.metodeBayar = $event) }, _cache[14] || (_cache[14] = [
						...
						createBaseVNode("div", _hoisted_32, [createBaseVNode("div", _hoisted_33, [createBaseVNode("div", _hoisted_34, [_cache[16] || (_cache[16] = createBaseVNode("div", { style: { "font-size": "20px" } }, "Jumlah Bayar", -1)), createBaseVNode("div", _hoisted_35, [createBaseVNode("div", _hoisted_36, [withDirectives(createBaseVNode("input", {
							type: "number",
