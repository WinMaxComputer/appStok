...
var _hoisted_45 = { class: "invoice-summary-col invoice-summary-col--notes" };
var _hoisted_46 = {
	key: 0,
				...
				createBaseVNode("div", _hoisted_6, [createBaseVNode("div", _hoisted_7, [createBaseVNode("div", _hoisted_8, [createBaseVNode("div", {
					...
					items.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_29, [createBaseVNode("div", _hoisted_30, [createBaseVNode("table", _hoisted_31, [createBaseVNode("thead", null, [createBaseVNode("tr", null, [(openBlock(true), createElementBlock(Fragment, null, renderList(columns.value, (item) => {
						...
						return openBlock(), createElementBlock("tr", { key: item.id }, [
							...
							createBaseVNode("td", _hoisted_34, toDisplayString(item.satuanBarang), 1),
					...
					createBaseVNode("div", _hoisted_43, [createBaseVNode("div", _hoisted_44, [createBaseVNode("div", _hoisted_45, [_cache[22] || (_cache[22] = createBaseVNode("div", { class: "invoice-bank-box" }, [createBaseVNode("div", { class: "inv-email-address" }, [
					...
					])], -1)), ttdPenerima.value ? (openBlock(), createElementBlock("div", _hoisted_46, [
					...
					])) : createCommentVNode("", true)]), createBaseVNode("div", _hoisted_49, [createBaseVNode("div", _hoisted_50, [
						createBaseVNode("div", _hoisted_51, [_cache[23] || (_cache[23] = createBaseVNode("span", null, "Sub Total", -1)), createBaseVNode("span", null, toDisplayString(formatNumber(subtotalBarang.value)), 1)]),
						items_jasa.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_52, [_cache[24] || (_cache[24] = createBaseVNode("span", null, "Sub Total Jasa", -1)), createBaseVNode("span", null, toDisplayString(formatNumber(subtotalJasa.value)), 1)])) : createCommentVNode("", true),
						createBaseVNode("div", _hoisted_53, [_cache[25] || (_cache[25] = createBaseVNode("span", null, "Grand Total", -1)), createBaseVNode("span", null, toDisplayString(formatNumber(grandTotal.value)), 1)])
					])])])])
				])])])], 512)])])]),
				createVNode(unref(D), {
