...
import { r as init_jspdf_es_min, t as require_jspdf_plugin_autotable } from "./jspdf.plugin.autotable-u_FPiHAc.js";
import { t as require_html2canvas } from "./html2canvas-5NJjBftB.js";
/* empty css                         */
import { t as D } from "./usemodal-vue3-BWxz8jOH.js";
import { n as E, r as require_html2pdf, t as QrcodeVue } from "./qrcode.vue.esm-BiC6wxCp.js";
require_html2canvas();
init_jspdf_es_min();
require_jspdf_plugin_autotable();
var import_html2pdf = /* @__PURE__ */ __toESM(require_html2pdf());
//#endregion
//#region resources/js/src/views/transaksi/invoicePenjualan.vue
...
var _hoisted_7 = { class: "invoice-paper-shell" };
var _hoisted_8 = {
...
var _hoisted_12 = { class: "inv--product-table-section invoice-hero-block" };
var _hoisted_13 = { class: "row invoice-hero-grid" };
var _hoisted_14 = { class: "col-sm-41 text-sm-end" };
var _hoisted_15 = { class: "col-sm-41 align-self-left" };
var _hoisted_16 = { class: "invoice-company-meta" };
var _hoisted_17 = { class: "inv-email-address" };
var _hoisted_18 = { key: 0 };
var _hoisted_19 = { class: "col-sm-41 text-sm-end" };
var _hoisted_20 = { class: "invoice-customer-card" };
var _hoisted_21 = { class: "inv-created-date" };
var _hoisted_22 = { class: "inv-date" };
var _hoisted_23 = { class: "inv-created-date" };
var _hoisted_24 = { class: "inv-date" };
var _hoisted_25 = { class: "inv-created-date" };
var _hoisted_26 = { class: "inv-date" };
var _hoisted_27 = { class: "inv-created-date" };
var _hoisted_28 = { class: "inv-date" };
var _hoisted_29 = {
	key: 0,
	class: "inv--product-table-section invoice-block"
};
var _hoisted_30 = { class: "table-responsive" };
var _hoisted_31 = { class: "invoice-items-table" };
...
var _hoisted_38 = { class: "invoice-items-table invoice-items-table--service" };
var _hoisted_39 = { class: "inv-email-address" };
var _hoisted_40 = { class: "text-end" };
var _hoisted_41 = { class: "text-end" };
var _hoisted_42 = { class: "text-end" };
var _hoisted_43 = { class: "inv--total-amounts invoice-summary-block" };
var _hoisted_44 = { class: "invoice-summary-row" };
var _hoisted_45 = { class: "invoice-summary-col invoice-summary-col--signature" };
var _hoisted_46 = {
	key: 0,
	class: "invoice-signature-box"
};
var _hoisted_47 = ["src"];
var _hoisted_48 = { class: "inv-email-address" };
var _hoisted_49 = { class: "invoice-summary-col invoice-summary-col--totals" };
var _hoisted_50 = { class: "invoice-total-box" };
var _hoisted_51 = { class: "invoice-total-line" };
var _hoisted_52 = {
	key: 0,
	class: "invoice-total-line"
};
var _hoisted_53 = { class: "invoice-total-line invoice-total-line--grand" };
var _hoisted_54 = { class: "col-xl-3" };
var _hoisted_55 = { class: "invoice-actions-btn" };
var _hoisted_56 = { class: "invoice-action-btn" };
...
var invoicePenjualan_default = /*#__PURE__*/ _plugin_vue_export_helper_default({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("div", _hoisted_1, [(openBlock(), createBlock(Teleport, { to: "#breadcrumb" }, [_cache[6] || (_cache[6] = createBaseVNode("ul", { class: "navbar-nav flex-row" }, [createBaseVNode("li", null, [createBaseVNode("div", { class: "page-header" }, [createBaseVNode("nav", {
				...
				createBaseVNode("div", _hoisted_6, [createBaseVNode("div", _hoisted_7, [createBaseVNode("div", _hoisted_8, [createBaseVNode("div", {
					class: "invoice-inbox",
					ref_key: "isi",
					ref: isi
					...
					createBaseVNode("div", _hoisted_12, [createBaseVNode("div", _hoisted_13, [
						_cache[18] || (_cache[18] = createBaseVNode("div", { class: "col-sm-41 me-auto" }, [createBaseVNode("div", { class: "d-flex align-items-start" }, [createBaseVNode("img", {
							class: "company-logo",
							src: "/build/assets/wm-DFHoJv8u.png",
							alt: "company"
						})])], -1)),
						_cache[19] || (_cache[19] = createBaseVNode("div", { class: "col-sm-41 text-sm-end" }, null, -1)),
						createBaseVNode("div", _hoisted_14, [noNota.value ? (openBlock(), createBlock(QrcodeVue, {
							key: 0,
						...
						createBaseVNode("div", _hoisted_15, [createBaseVNode("div", _hoisted_16, [
							_cache[7] || (_cache[7] = createBaseVNode("div", { class: "inv-street-addr" }, "Jln Raya Kutuh No.8 Tabanan - Bali", -1)),
							_cache[8] || (_cache[8] = createBaseVNode("div", { class: "inv-email-address" }, "theswamerta@gmail.com", -1)),
							_cache[9] || (_cache[9] = createBaseVNode("div", { class: "inv-email-address" }, "+6285 9361 00511", -1)),
							createBaseVNode("div", _hoisted_17, [createTextVNode("Term: " + toDisplayString(typeBayar.value === "0" ? "Cash" : "Kredit") + " ", 1), typeBayar.value === "1" ? (openBlock(), createElementBlock("span", _hoisted_18, "Tempo " + toDisplayString(new Date(jthTempo.value).toLocaleDateString("id-ID", {
								day: "2-digit",
								month: "2-digit",
								year: "numeric"
						...
						createBaseVNode("div", _hoisted_19, [createBaseVNode("div", _hoisted_20, [
							createBaseVNode("div", _hoisted_21, [
								...
								createBaseVNode("span", _hoisted_22, toDisplayString(noNota.value), 1)
							]),
							createBaseVNode("div", _hoisted_23, [
								_cache[12] || (_cache[12] = createBaseVNode("span", { class: "inv-title" }, "Invoice Date : ", -1)),
								_cache[13] || (_cache[13] = createTextVNode()),
								createBaseVNode("span", _hoisted_24, toDisplayString(new Date(tglNota.value).toLocaleDateString("id-ID", {
									day: "2-digit",
									month: "2-digit",
									year: "numeric"
								})), 1)
							...
							createBaseVNode("div", _hoisted_25, [
								...
								createBaseVNode("span", _hoisted_26, toDisplayString(nmPelanggan.value), 1)
							]),
							createBaseVNode("div", _hoisted_27, [
								_cache[16] || (_cache[16] = createBaseVNode("span", { class: "inv-title" }, "Alamat : ", -1)),
								_cache[17] || (_cache[17] = createTextVNode()),
								createBaseVNode("span", _hoisted_28, toDisplayString(alamatPelanggan.value), 1)
							])
						])])
					])]),
					items.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_29, [createBaseVNode("div", _hoisted_30, [createBaseVNode("table", _hoisted_31, [createBaseVNode("thead", null, [createBaseVNode("tr", null, [(openBlock(true), createElementBlock(Fragment, null, renderList(columns.value, (item) => {
						...
						return openBlock(), createElementBlock("tr", { key: item.id }, [
							...
							createBaseVNode("td", _hoisted_32, toDisplayString(Number(item.hrgJual).toLocaleString()), 1),
							createBaseVNode("td", _hoisted_33, toDisplayString(item.qty), 1),
							createBaseVNode("td", _hoisted_34, toDisplayString(item.satuanJual), 1),
							createBaseVNode("td", _hoisted_35, toDisplayString(Number(item.totalJual).toLocaleString()), 1)
						]);
					}), 128))])])])])) : createCommentVNode("", true),
					items_jasa.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_36, [createBaseVNode("div", _hoisted_37, [createBaseVNode("table", _hoisted_38, [createBaseVNode("thead", null, [createBaseVNode("tr", null, [(openBlock(true), createElementBlock(Fragment, null, renderList(columns_jasa.value, (item) => {
						return openBlock(), createElementBlock("th", {
							key: item.key,
							class: normalizeClass([item.class])
						}, toDisplayString(item.label), 3);
						...
						return openBlock(), createElementBlock("tr", { key: item.id }, [
							...
							createBaseVNode("td", null, [createTextVNode(toDisplayString(item.nmJasa) + " ", 1), createBaseVNode("p", _hoisted_39, toDisplayString(item.noteJasa), 1)]),
							createBaseVNode("td", _hoisted_40, toDisplayString(Number(item.biayaJasa).toLocaleString()), 1),
							createBaseVNode("td", _hoisted_41, toDisplayString(item.qtyJasa), 1),
							createBaseVNode("td", _hoisted_42, toDisplayString(Number(item.totalJasa).toLocaleString()), 1)
						]);
					}), 128))])])])])) : createCommentVNode("", true),
					createBaseVNode("div", _hoisted_43, [createBaseVNode("div", _hoisted_44, [
						_cache[25] || (_cache[25] = createBaseVNode("div", { class: "invoice-summary-col invoice-summary-col--notes" }, [createBaseVNode("div", { class: "invoice-bank-box" }, [createBaseVNode("div", { class: "inv-email-address" }, [
							createTextVNode("Rek BCA : 7724022244"),
							createBaseVNode("br"),
							createTextVNode(" An : Ni Putu Ita Liantika Oktia Dewi")
						]), createBaseVNode("div", { class: "inv-email-address" }, [
							createTextVNode("Invoice ini sudah di ttd secara digital oleh Swamerta Supplier"),
							createBaseVNode("br"),
							createTextVNode("Terima kasih")
						])])], -1)),
						createBaseVNode("div", _hoisted_45, [ttdPenerima.value ? (openBlock(), createElementBlock("div", _hoisted_46, [
							...
							createBaseVNode("div", _hoisted_48, toDisplayString(namaPenerima.value), 1)
						])) : createCommentVNode("", true)]),
						createBaseVNode("div", _hoisted_49, [createBaseVNode("div", _hoisted_50, [
							createBaseVNode("div", _hoisted_51, [_cache[22] || (_cache[22] = createBaseVNode("span", null, "Sub Total", -1)), createBaseVNode("span", null, toDisplayString(formatNumber(subtotalBarang.value)), 1)]),
							items_jasa.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_52, [_cache[23] || (_cache[23] = createBaseVNode("span", null, "Sub Total Jasa", -1)), createBaseVNode("span", null, toDisplayString(formatNumber(subtotalJasa.value)), 1)])) : createCommentVNode("", true),
							createBaseVNode("div", _hoisted_53, [_cache[24] || (_cache[24] = createBaseVNode("span", null, "Grand Total", -1)), createBaseVNode("span", null, toDisplayString(formatNumber(grandTotal.value)), 1)])
						])])
					])])
				])])])], 512)])])]),
				createVNode(unref(D), {
					...
					default: withCtx(() => [
						createBaseVNode("div", null, [_cache[26] || (_cache[26] = createBaseVNode("label", {
							for: "namaPenerima",
							class: "form-label"
				...
				createBaseVNode("div", _hoisted_54, [createBaseVNode("div", _hoisted_55, [createBaseVNode("div", _hoisted_56, [createBaseVNode("div", _hoisted_57, [
					...
					_ctx.$store.state.auth.user && _ctx.$store.state.auth.user === "root" ? (openBlock(), createElementBlock("div", _hoisted_61, [createBaseVNode("a", {
						href: "javascript:;",
						class: "btn btn-success btn-download",
					...
					createBaseVNode("div", _hoisted_62, [createVNode(_component_router_link, {
						...
						default: withCtx(() => _cache[27] || (_cache[27] = [createTextVNode("Back")])),
						_: 1
					}, 8, ["to"])]),
					_cache[28] || (_cache[28] = createBaseVNode("div", { class: "col-xl-12 col-md-3 col-sm-6" }, null, -1))
				])])])])
			])])])])]);
		};
	}
}, [["__scopeId", "data-v-7615c368"]]);
//#endregion
export { invoicePenjualan_default as default };
