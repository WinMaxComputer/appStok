...
//#region resources/js/src/views/laporan/penjualanBarang.vue?vue&type=style&index=0&scoped=92e582cb&lang.css
var import_vue_flatpickr_min = /* @__PURE__ */ __toESM(require_vue_flatpickr_min());
init_jspdf_es_min();
require_jspdf_plugin_autotable();
//#endregion
//#region resources/js/src/views/laporan/penjualanBarang.vue
...
var _hoisted_16 = { class: "d-flex align-items-center gap-2" };
var _hoisted_17 = ["onClick"];
var _hoisted_18 = { class: "row-action-icons" };
var _hoisted_19 = ["onClick"];
var _hoisted_20 = ["onClick"];
var _hoisted_21 = ["onClick"];
var penjualanBarang_default = /*#__PURE__*/ _plugin_vue_export_helper_default({
	__name: "penjualanBarang",
	setup(__props) {
		...
		const table_option = ref({
			...
			columnsClasses: { noPenjualan: "text-nowrap" },
			pagination: {
				nav: "scroll",
				chunk: 5
			},
			...
			initFilters: { GENERIC: route.query.filter || "" },
			filter: "",
			filterable: true,
			sortable: [
				"noPenjualan",
		...
		onMounted(() => {
			...
			bind_data();
			if (route.query.filter && tableRef.value && typeof tableRef.value.setFilter === "function") tableRef.value.setFilter(route.query.filter);
		...
		const viewnota = (id) => {
			...
			if (!currentFilter) {
				if (tableRef.value && tableRef.value.$refs && tableRef.value.$refs.table && tableRef.value.$refs.table.query) currentFilter = tableRef.value.$refs.table.query;
				if (!currentFilter) currentFilter = getTableFilterText();
			}
			const query = {
				startDate: sorting.value.startDate,
				endDate: sorting.value.endDate,
		...
		const delete_row = (data) => {
			new window.Swal({
				...
				if (result.value) store.dispatch("DeletePenjualan", { id: data.noPenjualan }).then((response) => {
					bind_data();
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("div", _hoisted_1, [(openBlock(), createBlock(Teleport, { to: "#breadcrumb" }, [_cache[4] || (_cache[4] = createBaseVNode("ul", { class: "navbar-nav flex-row" }, [createBaseVNode("li", null, [createBaseVNode("div", { class: "page-header" }, [createBaseVNode("nav", {
				...
				_cache[11] || (_cache[11] = createBaseVNode("div", { class: "d-flex flex-wrap justify-content-center justify-content-sm-start px-3 pt-3 pb-0" }, [createBaseVNode("h5", null, "Daftar Penjualan")], -1)),
				createBaseVNode("div", _hoisted_6, [createBaseVNode("div", _hoisted_7, [
					...
					createBaseVNode("div", _hoisted_10, [createBaseVNode("div", _hoisted_11, [_cache[5] || (_cache[5] = createBaseVNode("label", null, "Total Penjualan :", -1)), createBaseVNode("label", null, toDisplayString(Number(totalPenjualan.value).toLocaleString()), 1)])]),
					createBaseVNode("div", _hoisted_12, [createBaseVNode("div", _hoisted_13, [_cache[6] || (_cache[6] = createBaseVNode("label", null, "Total Piutang :", -1)), createBaseVNode("label", null, toDisplayString(Number(totalPiutang.value).toLocaleString()), 1)])]),
				...
				loading.value ? (openBlock(), createElementBlock("div", _hoisted_15, _cache[7] || (_cache[7] = [
				...
				createVNode(_component_v_client_table, {
					...
					noPenjualan: withCtx((props) => [createBaseVNode("div", _hoisted_16, [createBaseVNode("a", {
						href: "javascript:void(0);",
						onClick: ($event) => viewnota(_ctx.id = props.row.noPenjualan)
					}, toDisplayString(props.row.noPenjualan), 9, _hoisted_17), createBaseVNode("span", _hoisted_18, [
						createBaseVNode("a", {
							href: "javascript:void(0);",
							class: "row-action-icon text-primary",
							title: "Lihat",
							onClick: ($event) => viewnota(_ctx.id = props.row.noPenjualan)
						...
						createBaseVNode("a", {
							href: "javascript:void(0);",
							class: "row-action-icon text-warning",
							title: "Edit",
							onClick: ($event) => editnota([{
						...
						}, [createBaseVNode("path", { d: "M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z" })], -1)]), 8, _hoisted_20),
						createBaseVNode("a", {
							href: "javascript:void(0);",
							class: "row-action-icon text-danger",
							title: "Hapus",
					...
					subTotalPenjualan: withCtx((props) => [createTextVNode(toDisplayString(Number(props.row.subTotalPenjualan).toLocaleString()), 1)]),
					...
					termPenjualan: withCtx((props) => [createTextVNode(toDisplayString(props.row.termPenjualan), 1)]),
					jthTempo: withCtx((props) => [createTextVNode(toDisplayString(props.row.jthTempo ? unref(hooks)(props.row.jthTempo).format("DD-MM-YYYY") : ""), 1)]),
...
}, [["__scopeId", "data-v-92e582cb"]]);
//#endregion
export { penjualanBarang_default as default };
