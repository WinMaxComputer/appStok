...
import { c as init_typeof, s as _typeof$1 } from "./jspdf.plugin.autotable-RoyLOMaq.js";
//#region node_modules/core-js/internals/global.js
...
//#endregion
//#region node_modules/core-js/internals/engine-user-agent.js
var require_engine_user_agent = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = require_get_built_in()("navigator", "userAgent") || "";
}));
//#endregion
//#region node_modules/core-js/internals/engine-v8-version.js
...
//#endregion
//#region node_modules/core-js/internals/native-symbol.js
var require_native_symbol = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
var require_use_symbol_as_uid = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = require_native_symbol() && !Symbol.sham && typeof Symbol.iterator == "symbol";
}));
//#endregion
...
var require_shared_store = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	module.exports = global[SHARED] || defineGlobalProperty(SHARED, {});
}));
//#endregion
...
//#endregion
//#region node_modules/core-js/internals/native-weak-map.js
var require_native_weak_map = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var global = require_global();
	var isCallable = require_is_callable();
...
//#endregion
//#region node_modules/core-js/internals/engine-is-node.js
var require_engine_is_node = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = require_classof_raw()(require_global().process) == "process";
}));
//#endregion
...
//#endregion
//#region node_modules/core-js/internals/engine-is-ios.js
...
//#endregion
//#region node_modules/core-js/internals/engine-is-ios-pebble.js
...
//#endregion
//#region node_modules/core-js/internals/engine-is-webos-webkit.js
...
//#endregion
//#region node_modules/core-js/internals/engine-is-browser.js
...
var call$2, fixRegExpWellKnownSymbolLogic$2, anObject$3, toLength$4, toString$5, requireObjectCoercible$5, getMethod$2, advanceStringIndex$2, regExpExec$1;
var init_es_string_match = __esmMin((() => {
	...
	fixRegExpWellKnownSymbolLogic$2("match", function(MATCH, nativeMatch, maybeCallNative) {
		return [function match(regexp) {
			...
			var matcher = regexp == void 0 ? void 0 : getMethod$2(regexp, MATCH);
...
var apply$1, call$1, uncurryThis$6, fixRegExpWellKnownSymbolLogic$1, fails$2, anObject$2, isCallable, toIntegerOrInfinity, toLength$3, toString$4, requireObjectCoercible$4, advanceStringIndex$1, getMethod$1, getSubstitution, regExpExec, REPLACE, max, min$3, concat, push$1, stringIndexOf$1, stringSlice$2, maybeToString, REPLACE_KEEPS_$0, REGEXP_REPLACE_SUBSTITUTES_UNDEFINED_CAPTURE;
var init_es_string_replace = __esmMin((() => {
	apply$1 = require_function_apply();
	...
	stringIndexOf$1 = uncurryThis$6("".indexOf);
...
var $$6, uncurryThis$5, getOwnPropertyDescriptor$1, toLength$2, toString$3, notARegExp$2, requireObjectCoercible$3, correctIsRegExpLogic$2, IS_PURE$1, un$StartsWith, stringSlice$1, min$2, CORRECT_IS_REGEXP_LOGIC$1;
var init_es_string_starts_with = __esmMin((() => {
	$$6 = require_export();
	uncurryThis$5 = require_function_uncurry_this();
	...
	un$StartsWith = uncurryThis$5("".startsWith);
...
//#endregion
//#region node_modules/core-js/internals/create-iterator-constructor.js
var require_create_iterator_constructor = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
//#endregion
//#region node_modules/core-js/internals/define-iterator.js
var require_define_iterator = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var $ = require_export();
	var call = require_function_call();
	var IS_PURE = require_is_pure();
...
var global$1, DOMIterables, DOMTokenListPrototype, ArrayIteratorMethods, createNonEnumerableProperty, wellKnownSymbol, ITERATOR, TO_STRING_TAG, ArrayValues, handlePrototype;
var init_web_dom_collections_iterator = __esmMin((() => {
	global$1 = require_global();
	...
	for (var COLLECTION_NAME in DOMIterables) handlePrototype(global$1[COLLECTION_NAME] && global$1[COLLECTION_NAME].prototype, COLLECTION_NAME);
...
var $$5, $reduce, arrayMethodIsStrict$1, CHROME_VERSION, IS_NODE;
var init_es_array_reduce = __esmMin((() => {
	...
	$$5({
		target: "Array",
		proto: true,
		forced: !arrayMethodIsStrict$1("reduce") || !IS_NODE && CHROME_VERSION > 79 && CHROME_VERSION < 83
...
var $$4, uncurryThis$4, getOwnPropertyDescriptor, toLength$1, toString$2, notARegExp$1, requireObjectCoercible$2, correctIsRegExpLogic$1, IS_PURE, un$EndsWith, slice, min$1, CORRECT_IS_REGEXP_LOGIC;
var init_es_string_ends_with = __esmMin((() => {
	$$4 = require_export();
	uncurryThis$4 = require_function_uncurry_this();
	...
	un$EndsWith = uncurryThis$4("".endsWith);
...
//#endregion
//#region node_modules/core-js/internals/array-slice-simple.js
var require_array_slice_simple = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var toAbsoluteIndex = require_to_absolute_index();
	var lengthOfArrayLike = require_length_of_array_like();
...
var apply, call, uncurryThis$3, fixRegExpWellKnownSymbolLogic, isRegExp, anObject$1, requireObjectCoercible$1, speciesConstructor, advanceStringIndex, toLength, toString$1, getMethod, arraySlice, callRegExpExec, regexpExec, stickyHelpers, fails$1, UNSUPPORTED_Y, MAX_UINT32, min, $push, exec, push, stringSlice;
...
var $$2, uncurryThis$2, $IndexOf, arrayMethodIsStrict, un$IndexOf, NEGATIVE_ZERO, STRICT_METHOD;
var init_es_array_index_of = __esmMin((() => {
	$$2 = require_export();
	uncurryThis$2 = require_function_uncurry_this();
	$IndexOf = require_array_includes().indexOf;
	arrayMethodIsStrict = require_array_method_is_strict();
	un$IndexOf = uncurryThis$2([].indexOf);
...
var PROPER_FUNCTION_NAME, defineBuiltIn, anObject, $toString, fails, getRegExpFlags, TO_STRING, n$ToString, NOT_GENERIC, INCORRECT_NAME;
var init_es_regexp_to_string = __esmMin((() => {
	...
	TO_STRING = "toString";
	n$ToString = RegExp.prototype[TO_STRING];
...
__esmMin((() => {
	...
	import_raf = /* @__PURE__ */ __toESM(require_raf(), 1);
	init_es_string_trim();
	import_rgbcolor = /* @__PURE__ */ __toESM(require_rgbcolor(), 1);
