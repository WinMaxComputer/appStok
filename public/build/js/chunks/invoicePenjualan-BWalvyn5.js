...
import { n as E, r as require_html2pdf, t as js } from "./index.es-BkA3K9p-.js";
require_html2canvas();
init_jspdf_es_min();
...
var _hoisted_36 = { class: "table table-hover" };
...
var _hoisted_50 = { class: "col-sm-4 col-5" };
...
var _hoisted_55 = { class: "col-sm-4 col-5" };
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("div", _hoisted_1, [(openBlock(), createBlock(Teleport, { to: "#breadcrumb" }, [_cache[6] || (_cache[6] = createBaseVNode("ul", { class: "navbar-nav flex-row" }, [createBaseVNode("li", null, [createBaseVNode("div", { class: "page-header" }, [createBaseVNode("nav", {
				...
				createBaseVNode("div", _hoisted_6, [createBaseVNode("div", _hoisted_7, [createBaseVNode("div", {
					...
					items_jasa.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_34, [createBaseVNode("div", _hoisted_35, [createBaseVNode("table", _hoisted_36, [createBaseVNode("thead", null, [createBaseVNode("tr", null, [(openBlock(true), createElementBlock(Fragment, null, renderList(columns_jasa.value, (item) => {
						return openBlock(), createElementBlock("th", {
							key: item.key,
							class: normalizeClass([item.class])
						}, toDisplayString(item.label), 3);
					...
					createBaseVNode("div", _hoisted_41, [createBaseVNode("div", _hoisted_42, [
						_cache[24] || (_cache[24] = createBaseVNode("div", { class: "col-sm-51" }, [createBaseVNode("div", { class: "inv-email-address" }, [
						...
						createBaseVNode("div", _hoisted_47, [createBaseVNode("div", _hoisted_48, [createBaseVNode("div", _hoisted_49, [
							_cache[22] || (_cache[22] = createBaseVNode("div", { class: "col-sm-8 col-7" }, [createBaseVNode("div", { class: "text-end" }, "Sub Total:")], -1)),
							...
							items_jasa.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_52, _cache[21] || (_cache[21] = [createBaseVNode("div", { class: "text-end" }, "Sub Total Jasa", -1)]))) : createCommentVNode("", true),
							...
							_cache[23] || (_cache[23] = createBaseVNode("div", { class: "col-sm-8 col-7" }, [createBaseVNode("div", { class: "text-end" }, "Grand Total :")], -1)),
				...
				createVNode(unref(D), {
					...
					default: withCtx(() => [
						createBaseVNode("div", null, [_cache[25] || (_cache[25] = createBaseVNode("label", {
							for: "namaPenerima",
							class: "form-label"
				...
				createBaseVNode("div", _hoisted_57, [createBaseVNode("div", _hoisted_58, [createBaseVNode("div", _hoisted_59, [createBaseVNode("div", _hoisted_60, [
					...
					_ctx.$store.state.auth.user && _ctx.$store.state.auth.user === "root" ? (openBlock(), createElementBlock("div", _hoisted_64, [createBaseVNode("a", {
						href: "javascript:;",
						class: "btn btn-success btn-download",
						onClick: _cache[5] || (_cache[5] = ($event) => downloadWithCSS())
					}, "Download Winmax")])) : createCommentVNode("", true),
					createBaseVNode("div", _hoisted_65, [createVNode(_component_router_link, {
						to: {
						...
						default: withCtx(() => _cache[26] || (_cache[26] = [createTextVNode("Back")])),
						_: 1
					}, 8, ["to"])]),
					_cache[27] || (_cache[27] = createBaseVNode("div", { class: "col-xl-12 col-md-3 col-sm-6" }, null, -1))
				])])])])
			])])])])]);
		};
	}
}, [["__scopeId", "data-v-58e504a9"]]);
//#endregion
