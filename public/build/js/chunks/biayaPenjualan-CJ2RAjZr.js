...
var _hoisted_13 = { class: "table-responsive biaya-table-wrap" };
var _hoisted_14 = { class: "table table-sm biaya-table" };
...
var biayaPenjualan_default = /*#__PURE__*/ _plugin_vue_export_helper_default({
	...
	setup(__props) {
		...
		const hartalist = ref([]);
		const judulPage = ref("Biaya Penjualan / Hpp");
		const currentGroup = ref("5");
		const currentTitle = ref("Biaya Penjualan / Hpp");
		...
		onMounted(async () => {
			await loadGroup("5", "Biaya Penjualan / Hpp");
		});
		const show_biaya_penjualan = async () => {
			await loadGroup("5", "Biaya Penjualan / Hpp");
		};
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1, [(openBlock(), createBlock(Teleport, { to: "#breadcrumb" }, [_cache[7] || (_cache[7] = createBaseVNode("ul", { class: "navbar-nav flex-row" }, [createBaseVNode("li", null, [createBaseVNode("div", { class: "page-header" }, [createBaseVNode("nav", {
				...
				"aria-current": "page"
			}, [createBaseVNode("span", null, "COA Biaya Penjualan")])])])])])], -1))])), createBaseVNode("div", _hoisted_2, [createBaseVNode("div", _hoisted_3, [createBaseVNode("div", _hoisted_4, [createBaseVNode("div", _hoisted_5, [
				createBaseVNode("div", _hoisted_6, [createBaseVNode("div", _hoisted_7, [createBaseVNode("div", _hoisted_8, [createBaseVNode("div", _hoisted_9, [createBaseVNode("div", _hoisted_10, [createBaseVNode("div", _hoisted_11, [createBaseVNode("h4", null, toDisplayString(judulPage.value), 1)])])]), createBaseVNode("div", _hoisted_12, [createBaseVNode("div", _hoisted_13, [createBaseVNode("table", _hoisted_14, [_cache[8] || (_cache[8] = createBaseVNode("thead", null, [createBaseVNode("tr", null, [
					...
					createBaseVNode("th", { style: { "width": "100px" } }, "Aksi")
					...
					return openBlock(), createElementBlock("tbody", { key: row.acc_id }, [isSupportedLevel(row.level) ? (openBlock(), createElementBlock("tr", _hoisted_15, [
						...
						createBaseVNode("td", { class: normalizeClass(["text-end", { "fw-bold total-line": row.jenis === "Total" }]) }, [row.jenis === "Detail" || row.jenis === "Total" ? (openBlock(), createElementBlock("span", _hoisted_16, toDisplayString(formatAmount(row.amount)), 1)) : createCommentVNode("", true)], 2),
				...
				createBaseVNode("div", _hoisted_36, [createBaseVNode("div", _hoisted_37, [createBaseVNode("div", _hoisted_38, [createBaseVNode("div", _hoisted_39, [
					...
					createBaseVNode("div", _hoisted_40, [createBaseVNode("button", {
						type: "button",
						class: "btn btn-success btn-download w-100",
						onClick: show_biaya_penjualan,
						disabled: isLoadingList.value
					}, [isLoadingList.value ? (openBlock(), createElementBlock("span", _hoisted_42)) : createCommentVNode("", true), createTextVNode(" " + toDisplayString(isLoadingList.value ? "Memuat..." : "Biaya Penjualan / Hpp"), 1)], 8, _hoisted_41)]),
					createBaseVNode("div", _hoisted_43, [createBaseVNode("button", {
						type: "button",
						class: "btn btn-dark btn-edit w-100",
						onClick: loadData,
						disabled: isLoadingList.value
					}, "Muat Ulang", 8, _hoisted_44)])
				])])])])
			])])])])]);
		};
	}
}, [["__scopeId", "data-v-735a537e"]]);
//#endregion
export { biayaPenjualan_default as default };
